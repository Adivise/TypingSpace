module.exports = async(client, interaction) => {
    if (interaction.isCommand || interaction.isContextMenuCommand || interaction.isModalSubmit || interaction.isChatInputCommand) {
        ...
        client.createChannel(interaction.guild.id, interaction.user.id);
        client.createMoney(interaction.guild.id, interaction.user.id);
        client.createRoulette(interaction.guild.id);
